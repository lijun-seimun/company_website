...
export function Hero() {
  return (
    <section id="product" className="relative overflow-hidden bg-gradient-to-br from-background via-secondary/30 to-primary/5">
      {/* 装饰性背景元素 */}
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:gap-16">
          <div className="flex flex-col items-start">
            <h1 className="text-balance font-bold tracking-tight text-foreground">
              <span className="font-(--font-brand) text-3xl sm:text-4xl lg:text-5xl">GenesisScope<sup className="text-base sm:text-lg align-super">®</sup></span>
              <span className="mt-3 block text-3xl font-bold text-primary sm:text-4xl lg:text-5xl">
                胚胎发育实时监控系统
              </span>
            </h1>
