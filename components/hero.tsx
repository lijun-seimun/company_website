        ...
        <div className="grid items-center gap-8 sm:gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:gap-16">
          <div className="flex flex-col items-start">
            <h1 className="text-balance font-bold tracking-tight text-foreground">
              <span className="font-(--font-brand) text-2xl sm:text-4xl lg:text-5xl">GenesisScope<sup className="text-base sm:text-2xl lg:text-3xl" style={{verticalAlign: 'super', lineHeight: 0}}>®</sup></span>
